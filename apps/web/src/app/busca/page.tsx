...
export default async function BuscaPage({searchParams}: PageProps) {
  const resolvedSearchParams = await searchParams
  const q = normalizeParam(resolvedSearchParams.q) ?? ''
  const pageParam = normalizeParam(resolvedSearchParams.page) ?? '1'
        ...
        <section className="section-tight">
          <div className="container-content">
            ...
            >
              ...
              >
                Pesquise por temas, termos bíblicos, categorias e assuntos centrais do portal.
              </p>
              ...
              >
                ...
                <Link href="/sobre" style={{fontWeight: 700}}>
                  Conhecer o projeto
                </Link>
              </div>
              ...
              {q ? (
                <p>
                  {results.total} resultado(s) para “{q}”. Página {results.page} de{' '}
